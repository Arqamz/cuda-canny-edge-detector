...
int main(int argc, char *argv[])
{
  ...
  if(dirfilename != NULL){
  snprintf(composedfname, sizeof(composedfname), "output/%s_s_%3.2f_l_%3.2f_h_%3.2f.fim", basename,
  sigma, tlow, thigh);
  ...
  printf("Canny edge detection time: %.2f ms\n", process_time);
  ///////

  /****************************************************************************
   * Write out the edge image to a file.
   ****************************************************************************/
  snprintf(outfilename, sizeof(outfilename), "output/%s_s_%3.2f_l_%3.2f_h_%3.2f.pgm", basename,
    sigma, tlow, thigh);
